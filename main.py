...
X_train = pd.read_excel(r"/Hotel_sentiment/data/Data_train.xlsx")
...
w2vModel = word2vec.KeyedVectors.load_word2vec_format('/Hotel_sentiment/GoogleNews-vectors-negative300.bin', binary=True, limit=50000)
...
y_val = to_categorical(val_ratings)
